        ...
        <div className="max-w-md w-full space-y-8 bg-gray-900/50 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-gray-800/50 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="flex flex-col items-center space-y-4 animate-in fade-in duration-1000 delay-200">
            ...
            <p className="text-center text-sm text-gray-400">
              Or{' '}
              <Link href="/pages/signup" className="font-medium text-blue-500 hover:text-blue-400 transition-colors duration-200">
          ...
          <form className="mt-8 space-y-6 animate-in fade-in duration-1000 delay-300" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between animate-in fade-in duration-500 delay-600">
              <div className="flex items-center">
                <input
                  id="remember-me"
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-blue-500 focus:ring-blue-500 border-gray-700 rounded bg-gray-800/50 transition-colors duration-200"
                  disabled={isLoading}
                />
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-blue-500 hover:text-blue-400 transition-colors duration-200">
                  Forgot password?
                </Link>
              </div>
            </div>
