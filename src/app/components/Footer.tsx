      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h3 className="text-2xl font-bold text-blue-400 mb-2">Mudex Music</h3>
          ...
          <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-10">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="text-gray-400 hover:text-blue-400 transition-all duration-300 hover:transform hover:scale-110"
              >
        ...
        <div className="pt-8 border-t border-slate-800 text-center">
          <p className="text-gray-400 text-sm">&copy; 2025 Mudex Music. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
