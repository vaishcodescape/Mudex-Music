...
import { FaMusic, FaHeadphones, FaUserFriends, FaCode, FaGithub } from 'react-icons/fa';
        ...
        >
          <motion.div variants={fadeInUp} className="mb-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                Started in 2025 by Vaish, a passionate developer and lifelong music enthusiast, Mudex Music began as a personal project 
                to address the limitations of existing streaming platforms. Frustrated by clunky interfaces, limited discovery options, 
                and poor audio quality on other services, Vaish set out to build something better – a platform that truly understands 
                what music lovers want.
              </p>
              <p>
                The name "Mudex" combines "Music" and "Index," reflecting our core mission: to create the most comprehensive and 
                accessible index of music in the world. Our team has grown from a solo project to a dedicated group of developers, 
          ...
          <motion.div variants={fadeInUp} className="mb-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <ul>
                ...
                <li>
                  <strong>Seamless Cross-Platform Experience:</strong> Whether you're using our web app, mobile app, or desktop client, your experience, playlists, and preferences synchronize perfectly across all your devices.
                </li>
                <li>
          ...
          <motion.div 
            className="text-center border-t border-border/50 pt-12 mt-20"
            variants={fadeInUp}
            initial="hidden"
            animate="visible"
            target="_blank" 
