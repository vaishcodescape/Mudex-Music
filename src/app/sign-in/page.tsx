...
export default function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await signIn(formData.email, formData.password, formData.userType);
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sky-200/70 mt-2">Sign in to continue your music journey</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sky-200/70">
              ...
              <Link href="/sign-up" className="text-sky-400 hover:text-sky-300 font-medium transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
